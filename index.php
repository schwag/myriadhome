...
<!-- End Google Tag Manager -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <h2 class="text-center">E-COMMERCE SERVICES</h2>
                        ...
                        <p class="text-center greenBorder">The leadership at Myriad Core is as diverse as it is forceful. Our clients are exposed to world class project management, fanatical support, cutting edge development and an array of professional services - all managed by a duo of excellent minds.</p>
                            <div class="row text-center">
                                <div class="col-sm-6 smallHeading">
                                    ...
                                    <a href="#adam-leadership" role="button" class="caseButton" data-toggle="modal"><img src="img/adam_new.jpg" width="300px" height="300px" alt="Adam Yakish"></a>
                                    </div>
                                    <h4>Adam Yakish</h4>
                                ...
                                <div class="col-sm-6 smallHeading">
                                    <div class="hovergallery">
                                    <a href="#ryan-leadership" role="button" class="caseButton" data-toggle="modal"><img src="img/ryan_new.jpg" width="300px" height="300px" alt="Ryan Bardo"></a>
                                    </div>
                                    <h4>Ryan Bardo</h4>
        ...
        <section id="navMefour" class="gray-back">
            <div class="container">
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <h2 class="text-center">OUR WORK AT A GLANCE</h2>
